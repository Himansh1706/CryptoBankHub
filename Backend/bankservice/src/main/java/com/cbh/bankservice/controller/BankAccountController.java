...
public class BankAccountController {
    ...
    public ResponseEntity<Double> balance(@RequestBody CheckBalanceRequestDto checkBalanceRequestDto) {
        return ResponseEntity.ok(bankAccountService.checkBalance(checkBalanceRequestDto));
    }
