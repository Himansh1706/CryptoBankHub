...
public class BankAccountServiceImpl implements BankAccountService {
	...
	public BankAccount add(AddBankAccountRequestDto addBankAccountRequestDto) {
		...
		String kycStatus= webclientConfig.get(String.format("http://localhost:1011/user/kyc/%s", addBankAccountRequestDto.getUserId()), String.class);
		if (!"Approved".equals(kycStatus)) {
		    throw new UserBlockedException("User has not done kyc","");
		}
